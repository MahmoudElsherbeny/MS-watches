<div>
    ...
    <div id="quickview-wrapper">
        <!-- Modal -->
        <div wire:ignore.self class="modal fade" id="watche{{ $product->id }}" tabindex="-1" role="dialog">
                        ...
                        <div class="modal-product">
                            ...
                            <div class="product-info">
                                ...
                                @if($product->quantity > 0)
                                    {!! Form::Open(['wire:submit.prevent' => 'addToCart', 'class' => 'DeleteFormModal']) !!}
                                    <div class="select__quantity">
                                        <h2>Quantity :</h2>
                                        <div class="product__quantity">
                                            <input wire:model="qty" class="cart-plus-minus-box" type="number" name="qty" min="1">
                                        </div>
                                    </div>
