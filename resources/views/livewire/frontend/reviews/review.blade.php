            ...
            <div class="pro__review mb--50">
                ...
                <div class="review__control dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <button class="btn review_info" data-toggle="modal" data-target="#review{{ $review->id }}">Edit</button>
                        </li>
                        <li>
                            {!! Form::Open(['url' => route('review_delete', ['id' => $review->product_id, 'review' => $review->id])]) !!}
                ...
                <!-- Modal -->
                <div wire:ignore.self class="modal fade" id="review{{ $review->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal__container__sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                {!! Form::Open(['wire:submit.prevent' => 'update', 'method' => 'get', 'class' => 'DeleteFormModal']) !!}
                                <div class="rating__wrap">
                                    <h2 class="rating-title">Write  A review</h2>
                                    <div class="rating__stars">
                                        <h4 class="rating-title-2">Your Rating:</h4>
                                        <div class="rating__list">
                                            <!-- Start Single List -->
                                            <div class="rating">
                                                <input class="star star1" id="star1" type="radio" wire:model="edit_rate" name="edit_rate" value="5" />
                                                <label class="star star1" for="star1"></label>
                                                <input class="star star2" id="star2" type="radio" wire:model="edit_rate" name="edit_rate" value="4" />
                                                <label class="star star2" for="star2"></label>
                                                <input class="star star3" id="star3" type="radio" wire:model="edit_rate" name="edit_rate" value="3" />
                                                <label class="star star3" for="star3"></label>
                                                <input class="star star4" id="star4" type="radio" wire:model="edit_rate" name="edit_rate" value="2" />
                                                <label class="star star4" for="star4"></label>
                                                <input class="star star5" id="star5" type="radio" wire:model="edit_rate" name="edit_rate" value="1" />
                                                <label class="star star5" for="star5"></label>
                                            </div>
                                            <!-- End Single List -->
                                        </div>
                                ...
                                <div class="review__box mb--50">
                                    <div class="single-review-form">
                                        <div class="review-box message">
                                            <textarea wire:model="edit_review" name="edit_review" placeholder="Write your review"></textarea>
                                        </div>
                                    </div>
                                    <div class="review-btn">
                                        <button class="fv-btn" type="submit">update</button>
                                    </div>
                                </div>
                                {!! Form::Close() !!}
                            </div>
