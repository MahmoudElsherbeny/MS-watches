<div>
    ...
    {!! Form::Open(['wire:submit.prevent' => 'store']) !!}
        <div class="form-group">
            <label>Name:</label>
            <input class="form-control @error('name') input-error @enderror" type="text" name="name" wire:model="name" placeholder="Enter category name..." />
            @error('name')
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="icon" wire:model="icon">
                ...
                <option value="fa fa-tree">&#xf1bb;</option>
                <option value="fa fa-drupal">&#xf1a9;</option>
        ...
        <div class="form-group">
            <label>Order:</label>
            <input class="form-control @error('order') input-error @enderror" type="text" name="order" wire:model="order" placeholder="Enter category order..." />
            @error('order')
                <div class="msg-error">{{ $message }}</div>
            @enderror
        </div>
