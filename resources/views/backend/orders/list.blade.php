...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <h4 class="m-a-0 m-t-xs">Orders (<span id="cat_count">@if($categories){{count($categories)}}@endif</span>)</h4>
                </div>
                <div class="col-md-6">
            ...
            <table id="CategoriesTable" class="table table-striped table-vcenter js-dataTable-simple">
                <thead>
                    <tr>
                        ...
                        <th class="text-center hidden-xs">Deliverd By</th>
                    ...
                    @foreach ($categories as $key=>$category)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button class="btn btn-app" data-toggle="modal" data-target="#category{{ $category->id }}">Cancel</button>
                                </div>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-card-header">
                                                <div class="row">
                                                    <h4 class="col-md-11 text-left">Cancel Order</h4>
